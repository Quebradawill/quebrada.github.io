...
③ Never (or not) … without + -ing （每次…都…）= whenever<br>He never comes without bringing some present.
...
### （一）人称代词
表示“我，你，他，我们，你们，他们”等的词叫做人称代词。人称代词不仅指人，也可以指物，有人称、数和格的变化。
...
此时反身代词要重读，位置也比较灵活，可放在主语、宾语之后，也可位于句尾。<br>
例：Take good care of yourself.<br>
把自己照顾好。

### （四）相互代词

相互代词只有 each other 和 one another 两个词组。他们表示句中动词所叙述的动作或感觉在涉及的各个对象之间是相互存在的。<br>
例如：It is easy to see that the people of different cultures have always copied each other. 显而易见，不同文化的人总是相互借鉴的。

**句法功能：**

A、作动词宾语<br>
例：People should love one another.<br>
人们应当彼此相爱。
...
C、相互代词可加-'s构成所有格<br>
例：The students borrowed each other's notes.<br>
学生们互借笔记。
...
this 和 these 表示在时间上或空间上较近的人或物。<br>
例：This is a book. 这是一本书。
...
例：what is this? It is a panda.<br>
这是什么？是一只熊猫。

3、当说话者不清楚或者没有必要知道说话的对象的性别时，也可以用 it 来表示。<br>
例：What a beautiful baby! Is it a baby?<br>
多漂亮的宝宝啊，是个男孩吗？

4、用作非人称代词，表示时间、日期、 天气、温度距离等，常用作句子主语。<br>
例：It is a Saturday today.<br>
今天是星期六。

5、it 做形式主语或者形式宾语，而把不定式短语、动词 -ing 短语或者名词性从句等真正的主语或者宾语置于句末。<br>
例；It is impolite to speak to others with your mouth full of food.<br>
嘴里含着食物和人说话是不礼貌的。

6、用作 look、seem、appear、happen 等词的主语。<br>
例：It seems that he lose his way.<br>
他好像迷路了。

7、it 用在不能直接跟宾语从句的动词后面，尤其表示好恶的动词或者词组后边，如：enjoy、like、love、dislike、hate 等后。<br>
例：I like it when she sings a song for me.<br>
我喜欢她为我唱歌。
...
例：When shall we meet again?<br>
咱们什么时候见面？

Make it any day you like; it is all the same to me.<br>
你喜欢哪天就哪天，对我来说，哪天都无所谓。

Can you come on Monday or Tuesday?<br>
周一和周二你哪天能来？

I am afraid neither day is possible.<br>
这两天都不行。

例：Do you want tea or coffee?<br>
...
例：What are you doing now?<br>
你在做什么？<br>
Nothing.<br>什么也没有做。

（2）none 往往与前面的 some、any、every+名词相对应；nothing 往往与前面的 something、anything、everything 相对应；no one 往往与前面的 somebody、everybody、anybody 相对应。
...
each 强调个体，可做代词和形容词，指两个或者两个以上中的每一个；every 强调个体，只能作定语，指三个或者三个以上的每一个。each 做同位语时，不影响谓语动词的数，不可以用 not each 否定。

例：Each of the tickets costs 10dollers. = the tickets cost 10dollers each. = the tickets each cost 20doller.<br>每张票十美元。（后两句中，each 做同位语。）

4、another 与 the other 的区别

another 指另一个，是三者或者三者以上的另一个，泛指同类的人或者事物，可以单独使用或者在其后加单数可数名词。
the other+单数名词特指两者之中的另一个，可以用 the one 代替；the other+复数名词特指两者以上中剩下的所有的，可以用 the others 代替。
...
例：Who is here just now?<br>
刚才谁在这儿？

疑问代词还可以引导一个间接疑问句，也就是一个从句。疑问代词在句中可用作从句的主语，宾语，表语等成分。

例：What we should do is still unknown.<br>
我们该干什么仍然还不知道。
...
巧记形容词做定语的顺序：美小圆旧黄，法国木书房。<br>
美 beautiful 指性质，如好、坏等；小 small 指大小；圆 round 指形状；旧 old 指新旧；黄 yellow 指颜色；法国 French 指国籍或者产地；木 wooden 指材料或者质地；书 reading 指主要的用途；房 room 指中心词，前面的形容词都是修饰成分。

2、复合形容词的构成

A、副词词干+v.ing形式： hard-working 勤劳的<br>
B、名词词干+过去分词：man-made 人造的<br>
C、名词词干+v.ing：time-consuming 耗时的<br>
D、名词词干+形容词：world-famous 世界闻名的<br>
E、数次词干+名词：five-star五星级的<br>
F、数次词干+名词ed：three-legged三条腿的<br>
G、数次词干+名词+形容词：five-year-old五岁的<br>
H、形容词词干+过去分词：ready-made现成的<br>
I、形容词词干+名词ed：kind-hearted好心的<br>
J、形容词词干+v.ing：ordinary-looking相貌一般的<br>
K、形容词词干+形容词：red-hot炽热的
...
1）单音节形容词的比较级和最高级形式是在词尾加 -er 和 -est 构成。<br>
例：great（原级）greater（比较级）greatest（最高级）

2）以 -e 结尾的单音节形容词的比较级和最高级是在词尾加 -r 和 -st 构成。<br>
例：wide（原级）wider（比较级）widest（最高级）

3）少数以 -y，-er，-ow，-ble 结尾的双音节形容词的比较级和最高级是在词尾加 -er 和 -est 构成。<br>
例：clever（原级） cleverer（比较级）cleverest（最高级）

4）以 -y  结尾，但 -y 前是辅音字母的形容词的比较级和最高级是把 -y 去掉，加上 -ier 和 -iest 构成。<br>例：happy（原形）happier（比较级）happiest（最高级）

5）以重读闭音节+辅音字母结尾的形容词的比较级和最高级是双写该辅音字母然后再加 -er 和 -est。<br>
例：big（原级）bigger（比较级）biggest（最高级）

双音节和多音节形容词的比较级和最高级需用 more 和 the most 加在形容词前面来构成。<br>
例：beautiful（原级）difficult（原级）<br>
more beautiful（比较级）more difficult（比较级）<br>
...
$$
\begin{array}{lll} 原级 & 比较级 & 最高级 \\ \rm{good/well} & \rm{better} & \rm{best} \\ \rm{many} & \rm{more} & \rm{most} \\ \rm{much} & \rm{more} & \rm{most} \\ \rm{bad} & \rm{worse} & \rm{worst} \\ \rm{ill} & \rm{worse} & \rm{worst} \\ \rm{badly} & \rm{worse} & \rm{worst} \\ \rm{old} & \rm{elder/older} & \rm{eldest/oldest} \\ \rm{little} & \rm{littler/less(er)} & \rm{littlest/least} \\ \rm{far} & \rm{farther/further} & \rm{farthest/furthest} \\ \end{array}
$$


形容词前如加 less 和 least 则表示“较不”和“最不”<br>
important 重要，less important 较不重要，least important 最不重要<br>
